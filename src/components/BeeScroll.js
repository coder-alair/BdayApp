...
export default function BeeScrollAnimation() {
  ...
  useEffect(() => {
    ...
    const animation = gsap.to("#motionSVG", {
      scrollTrigger: {
        trigger: "#motionPath",
        start: "top center",
        end: 'bottom center',
  ...
  return (
    <div className='absolute top-[10rem] z-50 w-full'>
